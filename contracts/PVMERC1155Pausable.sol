...
import {ERC1155Pausable} from "./token/ERC1155/extensions/ERC1155Pausable.sol";
import {Ownable} from "./access/Ownable.sol";

contract PVMERC1155Pausable is ERC1155Pausable, Ownable {
    mapping(uint256 => uint256) private _totalSupply;

    constructor(
        string memory uri_
    ) ERC1155Pausable() ERC1155(uri_) Ownable(msg.sender) {}
